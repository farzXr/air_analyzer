...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\CO>
 */
class COFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        $endDate = Carbon::create(2025, 3, 11, 23, 59, 59); // Конец диапазона
        ...
        return [
            ...
            'time' => $randomDateTime, // Рандомная дата-время с округлением до интервала
        ];
    }
}
